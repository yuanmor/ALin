...
def main():
    ...
    if args.file:
        ...
        if args.quchong and args.txt_class:
            ...
            return
        elif args.src_path:#方法2
            os.system("python {1}\\fileall.py -f {0} -src {2}".format(args.file,current_file_dir,args.src_path,args.dst_path))
            return
